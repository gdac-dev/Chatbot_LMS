...
<div class="container">
    <div class="content">
        ...
        <script>
            var botmanWidget = {
                aboutText: '🔥 Powered by Arsene',
                title: 'GDAC CHATBOT',
                introMessage: "✋ Hi! I'm <strong>Arsene Bot</strong>. Welcome to this Platform. I'm here to help !",
                bubbleAvatarUrl: "/img/robot.png",
                placeholderText: "Type your command...",
                mainColor: "#347deb",
                bubbleBackground: "#347deb"
            };
        </script>
